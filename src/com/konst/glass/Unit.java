...
public class Unit {
     ...
     */
    private float getGlass() {
        return valuesUnit.getAsFloat(UnitTable.KEY_GLASS);
    }
     ...
     * @return Сумму денег.
     */
    private int getGlassCash() {
        return valuesUnit.getAsInteger(UnitTable.KEY_GLASS_CASH);
    }
     ...
     */
    private int getRate() {
        return valuesUnit.getAsInteger(UnitTable.KEY_RATE);
    }
     ...
     */
    private int getRatePrice() {
        return valuesUnit.getAsInteger(UnitTable.KEY_RATE_PRICE);
    }
     ...
     */
    private int getCash() {
        return valuesUnit.getAsInteger(UnitTable.KEY_CASH);
    }
     ...
     */
    private int getDays() {
        return valuesUnit.getAsInteger(UnitTable.KEY_DAYS);
    }
    ...
    private int getMonths() {
        return valuesUnit.getAsInteger(UnitTable.KEY_MONTHS);
    }
    ...
    private int getYears() {
        return valuesUnit.getAsInteger(UnitTable.KEY_YEARS);
    }
     ...
     */
    private int getExes() {
        return valuesUnit.getAsInteger(UnitTable.KEY_EXES);
    }

    private int getDepositMain() {
        return valuesUnit.getAsInteger(UnitTable.KEY_DEPOSIT_MAIN);
    }

    private int getDepositUnit() {
        return valuesUnit.getAsInteger(UnitTable.KEY_DEPOSIT_UNIT);
    }
     ...
     */
    private void setGlass(float glass) {
        valuesUnit.put(UnitTable.KEY_GLASS, glass);
    }
    ...
    private void setDays(int days) {
        valuesUnit.put(UnitTable.KEY_DAYS, days);
    }
    ...
    private void setMonths(int months) {
        valuesUnit.put(UnitTable.KEY_MONTHS, months);
    }
    ...
    private void setYears(int years) {
        valuesUnit.put(UnitTable.KEY_YEARS, years);
    }
     ...
     */
    private void setDepositMain(int depositMain) {
        valuesUnit.put(UnitTable.KEY_DEPOSIT_MAIN, depositMain);
    }
     ...
     */
    private void setDepositUnit(int depositUnit) {
        valuesUnit.put(UnitTable.KEY_DEPOSIT_UNIT, depositUnit);
    }
    ...
    private void cashPlus(int cash) {
        valuesUnit.put(UnitTable.KEY_CASH, getCash() + cash);
    }
     ...
     * @param cash Сумма денег в гривнах.
     */
    private void depositMainPlus(int cash) {
        valuesUnit.put(UnitTable.KEY_DEPOSIT_MAIN, getDepositMain() + cash);
    }
     ...
     * @param cash Сумма денег в гривнах.
     */
    private void depositUnitPlus(int cash) {
        valuesUnit.put(UnitTable.KEY_DEPOSIT_UNIT, getDepositUnit() + cash);
    }
     ...
     * @param cash сумма денег в гривнах.
     */
    private void cashMinus(int cash) {
        valuesUnit.put(UnitTable.KEY_CASH, getCash() - cash);
    }
    ...
    private void glassPlus(float glass) {
        valuesUnit.put(UnitTable.KEY_GLASS, getGlass() + glass);
    }
     ...
     */
    private void glassCashPlus(int cash) {
        valuesUnit.put(UnitTable.KEY_GLASS_CASH, getGlassCash() + cash);
    }
     ...
     * @param cash Сумма денег.
     */
    private void glassCashMinus(int cash) {
        valuesUnit.put(UnitTable.KEY_GLASS_CASH, getGlassCash() - cash);
    }
     ...
     * @param glass Стекло в килограммах.
     */
    private void glassMinus(float glass) {
        valuesUnit.put(UnitTable.KEY_GLASS, getGlass() - glass);
    }
     ...
     */
    private void update() {
        unitTable.updateEntry(Integer.valueOf(entry.getKey()), valuesUnit);
    }
